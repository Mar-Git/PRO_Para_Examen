...
public class AccessFileClaveAsimetrica {
    ...
    public void encriptarMensajeRSA(String nombreFicheroEntrada, String nombreFicheroSalida, String fichClavePublica) {
        ...
        try (FileInputStream fisClavePub = new FileInputStream(fichClavePublica)) {
